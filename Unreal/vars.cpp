...
const t_mem_model memmodel[(int)mem_model::n_models] =
{
    { "Pentagon", "PENTAGON", mem_model::pentagon, 128,  RAM_128 | RAM_256 | RAM_512 | RAM_1024 },
    { "TS-Config", "TSL", mem_model::tsl, 4096, RAM_4096 },
    { "ZX-Evo", "ATM3", mem_model::atm3, 4096, RAM_4096 },
    { "ATM-Turbo 2+ v7.10", "ATM710", mem_model::atm710, 1024, RAM_128 | RAM_256 | RAM_512 | RAM_1024 },
    { "ATM-Turbo v4.50", "ATM450", mem_model::atm450, 512,  RAM_512 | RAM_1024 },
    { "Profi", "PROFI", mem_model::profi, 1024, RAM_1024 },
    { "ZX-Spectrum +3", "PLUS3", mem_model::plus3, 128,  RAM_128 },
    { "ZS Scorpion", "SCORPION", mem_model::scorp, 256,  RAM_256 | RAM_1024 },
    { "ZS Scorpion + PROF ROM", "PROFSCORP", mem_model::profscorp, 256,  RAM_256 | RAM_1024 },
	{ "ZS Scorpion + GMX", "GMX", mem_model::gmx, 2048,  RAM_2048 },
    { "Nemo's KAY", "KAY", mem_model::kay, 256,  RAM_256 | RAM_1024 },
    { "Quorum", "QUORUM", mem_model::quorum, 1024, RAM_128 | RAM_1024 },
    { "Orel' BK-08 (LSY)", "LSY256", mem_model::lsy256, 256, RAM_256 },
	{ "ZXM-Phoenix v1.0", "PHOENIX", mem_model::phoenix, 1024, RAM_1024 | RAM_2048 },
};
